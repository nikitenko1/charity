...
import { getEventByDonor, deleteEvent } from './../redux/actions/eventActions';
...
const Event = () => {
  ...
  const { auth, alert, donorEvent } = useSelector((state) => state);
  ...
  useEffect(() => {
    dispatch(getEventByDonor(auth.accessToken));
  }, [dispatch, auth.accessToken]);

  useEffect(() => {
    setEvents(donorEvent.data);
  }, [donorEvent.data]);
